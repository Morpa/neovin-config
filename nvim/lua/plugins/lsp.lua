...
return {
  ...
  },
  {
    ...
    opts = {
      ...
      ensure_installed = { "ts_ls", "rust_analyzer", "gopls", "lua_ls", "biome", "tailwindcss" },
    },
  },
  {
    ...
    config = function()
      ...
      local global_tsserver = vim.fn.expand("$HOME/.local/share/fnm/aliases/default/bin/../lib/node_modules/typescript/lib/tsserver.js")
      ...
      vim.lsp.enable({ "ts_ls", "rust_analyzer", "gopls", "lua_ls", "biome", "tailwindcss" })
